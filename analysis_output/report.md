...
## Выручка по услугам
![Services by transaction amount](plots/services_by_transaction_amount.png)

Общая выручка за последний месяц: $142,371,459

![Last month amount by service](plots/last_month_amount_by_service.png)
...
![Client net worth category total amount](plots/client_net_worth_category_total_amount.png)

## Доля транзакций по способам оплаты
![Payment method](plots/payment_method_pie.png)

## Средняя сумма транзакции по возрасту клиента
![Average transaction by age](plots/avg_transaction_amount_by_client_age.png)
...
![Forecast next month](plots/forecast_next_month.png)
